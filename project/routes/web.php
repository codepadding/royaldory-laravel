...
Route::prefix('admin')->group(function () {
    ...
    //translate field
    //     Route::get('/update-translation',function (){
    //         $products=\App\Models\Subcategory::all();
    //         foreach ($products as $prod){
    //             $json=json_encode(["en"=>$prod->name]);
    //             $prod->name=$json;
    //             $prod->update();
    // //            dd($prod);
    //         }
    //         dd('its done, you are awesome!');
    //     });

    //affiliate code generate
    //    Route::get('/rand-code-affiliate',function (){
    ...
    Route::group(['middleware' => 'permissions:products'], function () {
        ...
        Route::get('/products/datatables/{cat_id?}', 'Admin\ProductController@datatables')->name('admin-prod-datatables'); //JSON REQUEST
        ...
        // translation routes
        Route::get('/products_translation_index', 'Admin\ProductController@TranslationIndex')->name('prod-translation-index');
        Route::post('/products_translation_update', 'Admin\ProductController@translationUpdate')->name('prod_translation_update');
        ...
        //Product Bulk Update
        Route::get('/products-update-index', 'Admin\ProductUpdateController@index')->name('admin-prod-bulk-index');
        Route::post('/products-update-index', 'Admin\ProductUpdateController@update')->name('admin-prod-bulk-update');
    ...
    Route::get('/mor/datatables', 'Admin\OrderReferralController@datatables')->name('admin-mor-datatables'); //JSON REQUEST
    Route::get('/mor', 'Admin\OrderReferralController@index')->name('admin-mor-index');
    Route::get('/mor/create', 'Admin\OrderReferralController@create')->name('admin-mor-create');
    Route::post('/mor/create', 'Admin\OrderReferralController@store')->name('admin-mor-store');
    Route::get('/mor/edit/{id}', 'Admin\OrderReferralController@edit')->name('admin-mor-edit');
    Route::post('/mor/edit/{id}', 'Admin\OrderReferralController@update')->name('admin-mor-update');
    Route::get('/mor/delete/{id}', 'Admin\OrderReferralController@destroy')->name('admin-mor-delete');
    Route::get('/mor/status/{id1}/{id2}', 'Admin\OrderReferralController@status')->name('admin-mor-status');
    ...
    Route::group(['middleware' => 'permissions:general_settings'], function () {
        ...
        Route::get('/general-settings/refferal', 'Admin\GeneralSettingController@refferal')->name('admin-gs-refferal');
        Route::get('/general-settings/order', 'Admin\GeneralSettingController@order')->name('admin-gs-order');
        ...
        Route::get('/shipping/status/{id1}/{id2}', 'Admin\VendorController@status')->name('admin-shipping-st');
        ...
        Route::get('/general-settings/refferal/{status}', 'Admin\GeneralSettingController@isrefferal')->name('admin-gs-isrefferal');
        Route::get('/general-settings/orderrefferal/{status}', 'Admin\GeneralSettingController@isorderrefferal')->name('admin-gs-isorderrefferal');
        Route::get('/general-settings/is_min_order/{status}', 'Admin\GeneralSettingController@is_min_order')->name('admin-gs-isminorder');
    ...
    //------------ Push Notification SECTION ENDS ------------
    Route::get('/push-notification/datatables', 'Admin\PushNotificationController@datatables')->name('admin-pn-datatables'); //JSON REQUEST
    Route::get('/push-notification', 'Admin\PushNotificationController@index')->name('admin-pn-index');
    Route::get('/push-notification/create', 'Admin\PushNotificationController@create')->name('admin-pn-create');
    Route::post('/push-notification/create', 'Admin\PushNotificationController@store')->name('admin-pn-store');
    Route::get('/push-notification/edit/{id}', 'Admin\PushNotificationController@edit')->name('admin-pn-edit');
    Route::post('/push-notification/edit/{id}', 'Admin\PushNotificationController@update')->name('admin-pn-update');
    Route::get('/push-notification/delete/{id}', 'Admin\PushNotificationController@destroy')->name('admin-pn-delete');
    Route::get('/push-notification/status/{id1}/{id2}', 'Admin\PushNotificationController@status')->name('admin-pn-status');
    ...
    Route::group(['middleware' => 'permissions:home_page_settings'], function () {
        ...
        Route::get('/app-slider/datatables', 'Admin\AppSliderController@datatables')->name('app-sl-datatables'); //JSON REQUEST
        Route::get('/app-slider', 'Admin\AppSliderController@index')->name('app-sl-index');
        Route::get('/app-slider/create', 'Admin\AppSliderController@create')->name('app-sl-create');
        Route::post('/app-slider/create', 'Admin\AppSliderController@store')->name('app-sl-store');
        Route::get('/app-slider/edit/{id}', 'Admin\AppSliderController@edit')->name('app-sl-edit');
        Route::post('/app-slider/edit/{id}', 'Admin\AppSliderController@update')->name('app-sl-update');
        Route::get('/app-slider/delete/{id}', 'Admin\AppSliderController@destroy')->name('app-sl-delete');

        //------------ App SLIDER SECTION ENDS ------------
    ...
    Route::group(['middleware' => 'permissions:payment_settings'], function () {
        ...
        Route::get('/general-settings/evb/{status}', 'Admin\GeneralSettingController@evb')->name('admin-gs-evb');
    ...
    Route::post('/products/multiple-status', 'Admin\ProductController@productStatusChange')->name('admin-prod-multiple-status');
    // STATUS SECTION ENDS

    // FEATURE SECTION
    Route::get('/products/feature/{id}', 'Admin\ProductController@feature')->name('admin-prod-feature');
    Route::post('/products/feature/{id}', 'Admin\ProductController@featuresubmit')->name('admin-prod-feature-new');
...
Route::prefix('user')->group(function () {
    /***********separeted for skipping phone validation start*************/
    // User Login
    ...
    Route::get('/send-otp', 'User\RegisterController@sendOtp')->name('user.sendotp');
    Route::post('/check_otp', 'User\RegisterController@checkOtp')->name('user.checkotp');
    Route::get('/otp', 'User\RegisterController@otp')->name('user.otp');
    // User Register End
    ...
    /***********separeted for skipping phone validation end*************/

    Route::middleware('isPhoneVerified')->group(function () {
        // User Dashboard
        ...
        // User Review
        Route::post('/review/submit', 'User\UserController@reviewsubmit')->name('front.review.submit-new');
        // User Review Ends
