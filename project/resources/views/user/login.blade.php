            ...
            <div class="login-area">
              ...
              <div class="login-form signin-form">
                ...
                <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                  ...
                  <div class="form-input">
                    <span class="icofont-eye showPassword" style="position: absolute;right: 15px;top: 50%;transform: translateY(-50%);font-size: 20px;color: #024D70;"></span>
                    <input type="password" class="login_password pr-5" name="password" placeholder="{{ $langg->lang174 }}"
                      required="">
            ...
            <div class="login-area signup-area">
              ...
              <div class="login-form signup-form">
                ...
                <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="text" class="Invcode" name="inv_code" placeholder="Invitation Code" >
