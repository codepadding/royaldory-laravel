                        ...
                        <div class="body-area">
                            ...
                            <form action="{{ route('admin-gs-update-payment') }}" id="geniusform" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Paypal Email') }}"
                                               name="paypal_business" value="{{ $gs->paypal_business }}" required="">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select class="process select droplinks {{ $gs->is_paytm == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1"
                                                        value="{{route('admin-gs-paytm',1)}}" {{ $gs->is_paytm == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-paytm',0)}}" {{ $gs->is_paytm == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Paytm Merchant') }}"
                                               name="paytm_merchant" value="{{ $gs->paytm_merchant }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Paytm Secret') }}"
                                               name="paytm_secret" value="{{ $gs->paytm_secret }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Paytm Website') }}"
                                               name="paytm_website" value="{{ $gs->paytm_website }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Paytm Industry') }}"
                                               name="paytm_industry" value="{{ $gs->paytm_industry }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="switch">
                                            <input type="checkbox" name="paytm_mode"
                                                   value="1" {{ $gs->paytm_mode == 'sandbox' ? "checked":"" }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select class="process select droplinks {{ $gs->is_molly == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1"
                                                        value="{{route('admin-gs-molly',1)}}" {{ $gs->is_molly == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-molly',0)}}" {{ $gs->is_molly == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="input-field" name="molly_key"
                                                  placeholder="{{ __('Molly Key') }}"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="input-field" name="molly_text"
                                                  placeholder="{{ __('Molly Text') }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select class="process select droplinks {{ $gs->is_razorpay == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1"
                                                        value="{{route('admin-gs-razor',1)}}" {{ $gs->is_razorpay == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-razor',0)}}" {{ $gs->is_razorpay == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="input-field" name="razorpay_key"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="input-field" name="razorpay_secret"
                                                  placeholder="{{ __('Razorpay Key') }}"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="input-field" name="razorpay_text"
                                                  placeholder="{{ __('Razorpay Text') }}"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            <h4 class="heading">
                                                {{ __('Royaldory Balance Checkout') }}
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select class="process select droplinks {{ $gs->evb_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                                <option data-val="1"
                                                        value="{{route('admin-gs-evb',1)}}" {{ $gs->evb_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-evb',0)}}" {{ $gs->evb_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Minimum Balance Limit') }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('300') }}"
                                               name="evb_limit" value="{{ $gs->evb_limit }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field"
                                               ...
                                               value="{{ $gs->fixed_commission * $curr->value }}" required="">
                                    </div>
                                </div>
