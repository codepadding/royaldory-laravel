...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Slider') }} <a class="add-btn" href="{{route('app-sl-index')}}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('app-sl-create') }}">{{ __('Add') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('app-sl-create')}}" method="POST"
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload full-width-img">
                                            <div id="image-preview" class="img-preview"
                                                ...
                                                <input type="file" name="photo" class="img-upload" id="image-upload" required>
                                            </div>
