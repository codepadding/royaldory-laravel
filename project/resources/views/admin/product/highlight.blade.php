                                    ...
                                    <div class="col-sm-3">
                                        <label class="switch">
                                            <input type="checkbox" name="trending"
                                                   value="1" {{ $data->trending == 1 ?"checked":"" }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
