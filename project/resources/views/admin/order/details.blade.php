                        ...
                        <div class="table-responsive-sm">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td width="10%">:</td>
                                    <td width="45%">{{$order->currency_sign}}{{ round($order->pay_amount * $order->currency_value) }}</td>
                                </tr>
                                <tr>
                            ...
                            <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                ...
                                @foreach($cart->items as $key => $product)
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset('assets/images/products/'.$product['item']['photo'])}}"
                                                 alt="product image" width="80px" height="80px"></td>
                                        <td>
                                        ...
                                        <td>{{$order->currency_sign}}{{ round($product['price'] * $order->currency_value) }}</td>
