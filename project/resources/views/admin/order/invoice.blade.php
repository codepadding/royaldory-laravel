    ...
    <div class="content-area">
        ...
        <div class="order-table-wrap">
            <div class="invoice-wrap">
                ...
                <br>
                <div class="row invoice__metaInfo ml-1 mb-4">
                    <div class="col-xs-12">
                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$order->currency_sign}}{{ round($subtotal) }}</td>
                                        </tr>
                                        @if($order->shipping_cost != 0)
                                            ...
                                            @if(DB::table('shippings')->where('price','=',$unroundedShippingPrice)->count() > 0)
                                                <tr>
                                                    <td colspan="2">{{ DB::table('shippings')->where('price','=',$unroundedShippingPrice)->first()->title }}
                                                        ({{$order->currency_sign}})
                                                    </td>
                                        ...
                                        @if($order->packing_cost != 0)
                                            ...
                                            @if(DB::table('packages')->where('price','=',$unroundedPprice)->count() > 0)
                                                <tr>
                                                    <td colspan="2">{{ DB::table('packages')->where('price','=',$unroundedPprice)->first()->title }}
                                                        ({{$order->currency_sign}})
                                                    </td>
                                        ...
                                        @if($order->coupon_discount != null)
                                            <tr>
                                                <td colspan="2">{{ __('Coupon Discount') }}({{$order->currency_sign}})
                                                </td>
