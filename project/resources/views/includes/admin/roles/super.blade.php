<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-prod-bulk-index') }}"><span>{{ __('Products Price Update') }}</span></a>
            </li>
            <li>
                <a href="{{ route('prod-translation-index') }}"><span>{{ __('Product Translation') }}</span></a>
            </li>
    ...
    <li>
        <a href="{{ route('admin-gs-refferal') }}"><i class="fas fa-user-plus"></i>{{ __('Refer & Earn') }}</a>
    </li>

    <li>
        <a href="{{ route('admin-mor-index') }}"><i class="fas fa-calendar-plus"></i>{{ __('Monthly Order Referral') }}</a>
    </li>
    ...
    <li>
        <a href="{{ route('admin-pn-index') }}" class=" wave-effect"><i class="fas fa-bell"></i>{{ __('Notifications') }}</a>
    </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-gs-order') }}"><span>{{ __('Order Limit') }}</span></a>
            </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('app-sl-index') }}"><span>{{ __('App Slider') }}</span></a>
            </li>
            <li>
