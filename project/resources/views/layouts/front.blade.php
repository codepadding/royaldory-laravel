                ...
                <div class="footer-widget recent-post-widget">
                    ...
                    <ul class="post-list">
                        ...
                        <li>
                            ...
                            <div class="post text-white" style="font-size: 18px">
                                <ul>
                                    @if ($ps->email != null)
                                        <li><i style="font-size: 18px" class="icofont-email"></i> {{$ps->email}}</li>
                                    @endif
                                    @if ($ps->street != null)
                                        <li><i style="font-size: 18px" class="icofont-google-map"></i> {{$ps->street}}
                                        </li>
                                    @endif
                                    @if ($ps->phone != null)
                                        <li><i style="font-size: 18px" class="icofont-smart-phone"></i> {{$ps->phone}}
                                        </li>
                                    @endif
                                </ul>
                            </div>
                        ...
                        <div class="login-area">
                            ...
                            <div class="login-form signin-form">
                                ...
                                <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                                    ...
                                    <div class="form-input">
                                        <span class="icofont-eye showPassword"
                                              style="position: absolute;right: 15px;top: 50%;transform: translateY(-50%);font-size: 20px;color: #024D70;"></span>
                                        <input type="password" class="login_password pr-5" name="password"
                        ...
                        <div class="login-area signup-area">
                            ...
                            <div class="login-form signup-form">
                                ...
                                <form class="mregisterform" action="{{route('user-register-submit')}}"
                                    ...
                                    <div class="form-input">
                                        <input type="text" class="Invcode" name="invitation_code"
                ...
                <div class="login-area">
                    ...
                    <div class="login-form">
                        ...
                        <form id="mforgotform" action="{{route('user-forgot-submit')}}" method="POST">
                            {{ csrf_field() }}
                            <div class="form-input">
                                <input type="text" name="phone" class="phone" placeholder="{{ $langg->lang184 }}"
                                       required="">
                                <i class="icofont-phone"></i>
                            </div>
                        ...
                        <div class="login-area">
                            <div class="login-form signin-form">
                                ...
                                <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                                    {{ csrf_field() }}
                                    <div class="form-input">
                                        <input type="text" name="phone" placeholder="{{ $langg->lang173 }}" required="">
                                        <i class="icofont-user-alt-5"></i>
                                    </div>
                                    <div class="form-input">
                                        <input type="password" class="Password" name="password"
