...
class UserController extends Controller
{
    ...
    public function profileupdate(Request $request)
    {
        ...
        [
            ...
            'phone' => 'required|regex:/(01)[0-9]{9}/|unique:users,phone,'.Auth::user()->id.',id',
        ];
        ...
        $data = Auth::user();        
            ...
            if($request->phone != $data->phone){
                ...
                $input['temp_otp']=$otp;
                $input['otp_validity']=Carbon::parse()->addMinutes(5)->format('Y-m-d H:i:s');
                $data->update($input);
                $msg = "$otp is your One Time Password (OTP) for http://evendory.com. OTP is valid till ".Carbon::parse($data->otp_validity)->format('H:i:s');
