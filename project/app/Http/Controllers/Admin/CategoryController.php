...
class CategoryController extends Controller
{
    ...
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('name_bn',function (Category $data){
    ...
    public function store(Request $request)
    {
        ...
        if ($file = $request->file('photo')) {
            ...
            $file->move('assets/images/categories/originals', $name);


            $save_path=public_path('assets/images/categories/');
            $img = Image::make(public_path().'/assets/images/categories/originals/'.$name)->fit(300)->encode('jpg',75);
            ...
            $save_path=public_path('assets/images/categories/app/');
            if (!file_exists($save_path)) {
                mkdir($save_path, 666, true);
            }
            $img = Image::make(public_path().'/assets/images/categories/'.$name)->fit(150)->encode('jpg',75);
            $img->save($save_path.$name);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($file = $request->file('photo')) {
            ...
            if ($data->photo != null) {
                if (file_exists(public_path() . '/assets/images/categories/originals/' . $data->photo)) {
                    unlink(public_path() . '/assets/images/categories/originals/' . $data->photo);
                }
                ...
                if (file_exists(public_path() . '/assets/images/categories/app/' . $data->photo)) {
                    unlink(public_path() . '/assets/images/categories/app/' . $data->photo);
                }
            }
            $input['photo'] = $name;
        }
