...
$(document).ready(function(){
        var sound_path="https://evendory.com/assets/admin/sounds/notification_sound.mp3";
        var audioElement = document.createElement('audio');
        audioElement.setAttribute('src', sound_path);
        ...
        //         success:function(data){
        //             var old_order=parseInt($("#order-notf-count").text());
        //             if(old_order < data){
        //                 audioElement.play();
